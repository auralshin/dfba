...
contract AuctionHouseTest is Test {
    ...
    function setUp() public {
        ...
        // Fund test accounts
        baseToken.mint(alice, 10000 * 10**18);
        baseToken.mint(bob, 10000 * 10**18);
        baseToken.mint(carol, 10000 * 10**18);
        quoteToken.mint(alice, 10000 * 10**18);
        quoteToken.mint(bob, 10000 * 10**18);
        quoteToken.mint(carol, 10000 * 10**18);
    }
