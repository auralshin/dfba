...
contract AuctionHouseFuzzTest is Test {
    ...
    function setUp() public {
        ...
        weth.mint(alice, 1_000 * 10**18);
        weth.mint(bob, 1_000 * 10**18);
        weth.mint(carol, 1_000 * 10**18);
    }
    ...
    function testFuzz_OrderKeyUniqueness(
        ...
        bool shouldDiffer = (trader1 != trader2) || 
                           (nonce1 != nonce2) || 
                           (tick1 != tick2) || 
                           (qty1 != qty2);
    ...
    function testFuzz_ClearingPriceValidity(
        int24 bidTick,
        int24 askTick,
        uint128 bidQty,
        uint128 askQty
    ...
    function testFuzz_FilledQuantityBounds(
        int24 priceTick,
        uint128 orderQty,
        uint128 counterQty
    ) public {
